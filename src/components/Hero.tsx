      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 relative animate-fade-in">
            <div className="relative md:translate-x-56 lg:translate-x-64">
              {/* WhatsApp-like container */}
              <div className="max-w-sm mx-auto">
                {/* Chat messages */}
                <div className="p-4 space-y-4 bg-[#E5DDD5] bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] rounded-2xl">
                  {/* Assistant message */}
                  ...
                  <div className="flex items-start gap-2 max-w-[85%]">
                    <div className="bg-white rounded-lg p-3 shadow-sm">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        <button className="bg-[#25D366] hover:bg-[#1ea952] text-white px-4 py-1.5 rounded-full text-xs transition-colors">
                          14h
                        </button>
                        <button className="bg-[#25D366] hover:bg-[#1ea952] text-white px-4 py-1.5 rounded-full text-xs transition-colors">
                          15h30
                ...
                {/* Chat input */}
                <div className="mt-2 bg-[#F0F2F5] rounded-full px-4 py-2.5 text-sm text-gray-400">
                  Digite uma mensagem...
                </div>
              </div>
